...
export default [
  ...
  },
  {
    ...
    techStack: 'Slider 제작, Scroll Animation, Video Handling, Gulp, less, css3, gsap, ie8+, swiper',
    description: '메인 페이지의 슬라이드를 정림에서 요구하는 스타일로 하려다 보니 새로 만들게 되었습니다. ' +
      '</br>' +
      ' PC로 접속 시 PC 페이지가 모바일로 접속 시 모바일 페이지가 나옵니다.<br/>' +
      '<a target="_blank" href="http://www.junglim.co.kr/identity/brand">http://www.junglim.co.kr/identity/brand</a> 이곳에서 IDENTITY 밑의 화살표를 누르면 브랜드 스토리가 스크롤 애니메이션 형식으로 펼쳐집니다.'
  },
  {
    name: '홀로티브 홈페이지 구축',
